  ...
  function testaxios() {
    ...
    const getToken = axios({
      ...
      data: {
        ...
        imp_secret:
          "b9cb96c92d43544b6f2b2b155d961903edd5419f750454e7321e5235438e1476c0030cfca8db3ac4", // REST API Secret
      },
    });
  }
    ...
    <ThemeProvider theme={Colortheme}>
      <Wrapper>
        <Container>
          ...
          <PhoneButton onClick={onClickCertification}>휴대폰 인증</PhoneButton>
